...
namespace backend.Services
{
    public class NormaService
    {
        ...
        public async Task<NormaModel> CreateNormaAsync(NormaModel norma)
        {
            ...
            norma.UpdateBy = AuditHelper.ResolveUpdateBy(norma.UpdateBy, norma.CreateBy);
        ...
        public async Task<NormaModel> UpdateNormaAsync(NormaModel norma)
        {
            ...
            existingNorma.UpdateBy = AuditHelper.ResolveUpdateBy(norma.UpdateBy, norma.CreateBy, existingNorma.UpdateBy ?? existingNorma.CreateBy ?? "Sistema");
