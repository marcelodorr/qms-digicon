...
namespace backend.Services
{
    public class ClienteService
    {
        ...
        public async Task<ClienteModel> CreateClienteAsync(ClienteModel cliente)
        {
            ...
            cliente.UpdateBy = AuditHelper.ResolveUpdateBy(cliente.UpdateBy, cliente.CreateBy);
        ...
        public async Task<ClienteModel> UpdateClienteAsync(ClienteModel cliente)
        {
            ...
            existingCliente.UpdateBy = AuditHelper.ResolveUpdateBy(cliente.UpdateBy, cliente.CreateBy, existingCliente.UpdateBy ?? existingCliente.CreateBy ?? "Sistema");
