...
export const MODULE_KEYS = {
  dashboard: "dashboard",
  rncDashboard: "qualidade.dashboard-rnc",
  ...
  shippingLabels: "etiquetas.etiqueta-embarque",
  settings: "settings",
} as const;
...
export const MODULE_DEFINITIONS: ModuleDefinition[] = [
  { key: MODULE_KEYS.dashboard, label: "Dashboard Certificado", path: "/dashboard-certificado", group: "Certificados" },
  { key: MODULE_KEYS.rncDashboard, label: "Dashboard RNC", path: "/qualidade/dashboard-rnc", group: "Qualidade" },
  ...
  { key: MODULE_KEYS.shippingLabels, label: "Etiqueta de embarque", path: "/etiquetas/etiqueta-embarque", group: "Etiquetas" },
