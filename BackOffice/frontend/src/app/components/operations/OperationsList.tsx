...
export function OperationsList({ 
  ...
  const columns = React.useMemo<GridColDef<Operation>[]>(() => {
    const baseColumns: GridColDef<Operation>[] = [
      {
        field: 'code',
        headerName: 'Código',
        width: 200,
        renderCell: (params) => (
          <span className="font-medium font-mono">{params.value}</span>
        ),
      },
      {
        field: 'description',
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-900">Cadastro de Operações</h2>
          <p className="text-slate-500">Gerencie os códigos e descrições das operações do sistema.</p>
        </div>
        {canManage && (
            ...
            <div className="flex items-center gap-4 flex-1">
              ...
              >
                ...
                <div className="flex gap-2 mt-2">
                  <label htmlFor="op-file-upload" className="cursor-pointer">
