  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-900">Cadastro de Clientes</h2>
          <p className="text-slate-500">Gerencie os clientes e seus endereços.</p>
        </div>
        {canManage && (
