...
public sealed record ProductionOrderDto(Guid Id, Guid MachineId, string Code, string ProductName, int TargetQuantity, string Revision);
public sealed record OperationDto(Guid Id, Guid PoId, string Name, string Code);
